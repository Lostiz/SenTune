...
pub fn run() {
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::netease::search_netease,
            commands::netease::search_netease_artists,
            commands::netease::get_netease_artist_detail,
            commands::netease::get_netease_artist_songs,
            commands::netease::get_netease_artist_albums,
            commands::netease::get_netease_album_detail,
            commands::netease::netease_play_url,
            commands::netease::netease_lyric,
            commands::netease::start_netease_stream,
            commands::netease::add_netease_favorite,
            commands::netease::remove_netease_favorite,
            commands::netease::list_netease_favorites,
            commands::netease::add_netease_history,
            commands::netease::list_netease_history,
            commands::netease::clear_netease_history,
