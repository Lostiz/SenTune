...
function artistIdFromHash(): number | null {
  const match = window.location.hash.match(/^#\/artist\/(\d+)/);
...
export default function App() {
  ...
  const [artistId, setArtistId] = useState<number | null>(artistIdFromHash);
